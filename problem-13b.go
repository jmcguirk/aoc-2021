...
func (this *Problem13B) NumDots() int {
...
func (this *Problem13B) ApplyVerticalFold(fold *FoldInstruction) {
...
func (this *Problem13B) ApplyHorizontalFold(fold *FoldInstruction) {
	newGrid := &IntegerGrid2D{};
	newGrid.Init();
